   ...
   <body>
    ...
    <div class="se-pre-con"></div>
      ...
      <nav class="light-blue lighten-1" role="navigation">
         <div class="nav-wrapper container"><a  class="brand-logo">SUST Bengali Pos Tagger</a>
      ...
      <div class="section no-pad-bot" id="index-banner">
         <div class="container text-center">
            ...
            <center>
               ...
               <div class="row center">
                  <h5 class="header col s12 light">Bengali Rule Based Pos Tagger For Verb
                  </h5>
               </div>
            </center>
              ...
              {!! Form::open(array('url' => '/generate', 'method' => 'post', 'files' => true, 'id'=>'empty')) !!}
               <center>
                  <div class="form-group">
                    ...
                    <!-- <select name="type">
                          <option value="Withoutout">Without Category</option>
       ...
       @if( strpos($filepath, '/Data/Output/') === 0)
        <center>
           <p>  <em>Download Tagged Result.....</em> <a download href="{!! $filepath!!}" target="_blank"><i class="material-icons">get_app</i></a></p>
        </center>
        @else
        @endif
         ...
         <div class="container">
            <div class="row">
               <div class="col l6 s12">
                  ...
                  <p class="grey-text text-lighten-4">Bengali Rule Based Pos Tagger For Verb</p>
               </div>
            </div>
         </div>
